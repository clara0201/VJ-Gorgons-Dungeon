...
public class SatyrBehaviour : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Satyr_Behaviour();
        if (anim.GetCurrentAnimatorClipInfo(0).Length > 0 && anim.GetCurrentAnimatorClipInfo(0)[0].clip.name == "Satyr_Attack_02")
        {
            ...
            if (anim.GetCurrentAnimatorClipInfo(0).Length > 0 && anim.GetCurrentAnimatorStateInfo(0).normalizedTime >= 1.0f) EndAnimation();
        }
        if (anim.GetCurrentAnimatorClipInfo(0).Length > 0 && anim.GetCurrentAnimatorClipInfo(0)[0].clip.name == "Satyr_Hit" && (anim.GetCurrentAnimatorStateInfo(0).normalizedTime >= 0.85f) && (anim.GetCurrentAnimatorStateInfo(0).normalizedTime < 0.87f) && health <= 0)
        {
            //audio de morir
            Die();
        }
