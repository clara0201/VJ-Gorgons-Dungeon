...
public class MinotaurBehaviour : MonoBehaviour
{
    ...
    {
        Minotaur_Behaviour();
        if (anim.GetCurrentAnimatorClipInfo(0).Length > 0 && anim.GetCurrentAnimatorClipInfo(0)[0].clip.name == "Minotaur_Attack_01")
        {
        ...
        if (anim.GetCurrentAnimatorClipInfo(0).Length > 0 && anim.GetCurrentAnimatorClipInfo(0)[0].clip.name == "Minotaur_Hit" && (anim.GetCurrentAnimatorStateInfo(0).normalizedTime >= 0.85f) && (anim.GetCurrentAnimatorStateInfo(0).normalizedTime < 0.87f) && health <= 0)
        // audio de morir
        {
            Die();
        }
    ...
    public void Minotaur_Behaviour(){
